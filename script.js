...
var itemConstructors = [["gun", "glock", 1, GunImgs[0]], ["gun", "western", 1, GunImgs[1]], ["gun", "rare pistol", 1, GunImgs[2]], ["consumable", "cheese", 1, ItemImgs[0]], ["consumable", "soda", 1, ItemImgs[1]], ["consumable", "common battery", 1, ItemImgs[2]], ["consumable", "rare battery", 1, ItemImgs[3]], ["consumable", "legendary battery", 1, ItemImgs[4]], ["projectile", "grenade", 1, ProjImgs[0]], ["projectile", "rock", 10, ProjImgs[1]], ["material", "common card", 1, MatImgs[0]], ["material", "rare card", 1, MatImgs[1]], ["material", "legendary card", 1, MatImgs[2]]];
...
function setup() {
  ...
  NonPlayerCharacters.push(new NPC(1000, 100, "Buschy", ["Buschy: granny smith apple", "Wing: Red delicious apple", "Mario: Honeycrisp apple", "Luigi: Carrot", "Luigi: Haha u thought I was gon say apple"]));
}
